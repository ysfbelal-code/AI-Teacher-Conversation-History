    ...
    for m in models:
        try:
            ...
            r = c.chat.completions.create(
                model=m,
                messages=[{'role':'system', "content": "You follow instructions exactly. Output ONLY what is asked — no preamble, no explanation, no extra text. If there's a word with multiple meanings in the other language, output the first thing that comes to mind. Avoid outputs like \frac{2420}{20} when solving equations. USe the actual mathematical symbold if you can."}, 
